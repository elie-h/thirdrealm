...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app w3b-5e5d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app w3b-5e5d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'w3b-5e5d-staging' does not match app name in config file 'w3b-5e5d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name w3b-5e5d-db
  fly postgres attach --postgres-app w3b-5e5d-db --app w3b-5e5d

  fly postgres create --name w3b-5e5d-staging-db
  fly postgres attach --postgres-app w3b-5e5d-staging-db --app w3b-5e5d-staging
  ```
